	...
	public function renderFields( $item_id, $item, $depth, $args ) {
		...
		<p class="field-gantrymenu_large_direction description description-thin">
			<label for="edit-menu-item-gantrymenu_large_direction-<?php echo $item_id; ?>">
				...
				<select id="edit-menu-item-gantrymenu_large_direction-<?php echo $item_id; ?>" class="widefat edit-menu-item-gantrymenu_large_direction" name="menu-item-gantrymenu_large_direction[<?php echo $item_id; ?>]">
					<option value="rt-dropdown-left-large"<?php if( esc_attr( $item->gantrymenu_large_direction ) == 'rt-dropdown-left-large' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Left Direction' ); ?></option>
					<option value="rt-dropdown-right-large"<?php if( esc_attr( $item->gantrymenu_large_direction ) == 'rt-dropdown-right-large' || esc_attr( $item->gantrymenu_large_direction ) == '' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Right Direction' ); ?></option>
				</select>
			</label>
		</p>
		...
		<p class="field-gantrymenu_desktop_direction description description-thin">
			<label for="edit-menu-item-gantrymenu_desktop_direction-<?php echo $item_id; ?>">
				<?php _re( 'Dropdown on Desktop' ); ?><br />
				<select id="edit-menu-item-gantrymenu_desktop_direction-<?php echo $item_id; ?>" class="widefat edit-menu-item-gantrymenu_desktop_direction" name="menu-item-gantrymenu_desktop_direction[<?php echo $item_id; ?>]">
					<option value="rt-dropdown-left-desktop"<?php if( esc_attr( $item->gantrymenu_desktop_direction ) == 'rt-dropdown-left-desktop' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Left Direction' ); ?></option>
					<option value="rt-dropdown-right-desktop"<?php if( esc_attr( $item->gantrymenu_desktop_direction ) == 'rt-dropdown-right-desktop' || esc_attr( $item->gantrymenu_desktop_direction ) == '' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Right Direction' ); ?></option>
				</select>
			</label>
		</p>
		...
		<p class="field-gantrymenu_tablet_direction description description-thin">
			<label for="edit-menu-item-gantrymenu_tablet_direction-<?php echo $item_id; ?>">
				...
				<select id="edit-menu-item-gantrymenu_tablet_direction-<?php echo $item_id; ?>" class="widefat edit-menu-item-gantrymenu_tablet_direction" name="menu-item-gantrymenu_tablet_direction[<?php echo $item_id; ?>]">
					<option value="rt-dropdown-left-tablet"<?php if( esc_attr( $item->gantrymenu_tablet_direction ) == 'rt-dropdown-left-tablet' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Left Direction' ); ?></option>
					<option value="rt-dropdown-right-tablet"<?php if( esc_attr( $item->gantrymenu_tablet_direction ) == 'rt-dropdown-right-tablet' || esc_attr( $item->gantrymenu_tablet_direction ) == '' ) : ?> selected="selected"<?php endif;?>><?php _re( 'Right Direction' ); ?></option>
				</select>
			</label>
		</p>
