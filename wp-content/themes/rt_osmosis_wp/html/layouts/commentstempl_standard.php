					...
					<div class="comments-pagination">
						<ul>
							<li class="pagination-prev">
								<?php previous_comments_link( '<i class="fa fa-arrow-left"></i> ' . _r( 'Older Comments' ) ); ?>
							</li>
							<li class="pagination-next">
								<?php next_comments_link( _r( 'Newer Comments' ) . ' <i class="fa fa-arrow-right"></i>'  ); ?>
							</li>
						</ul>
					</div>
					...
					<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="comments-form">
						...
						<?php if( is_user_logged_in() ) : ?>
							...
							<p class="logged-in-as">
								<?php echo sprintf( _r( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" class="btn btn-mini btn-logout" title="Log out of this account">Log out?</a>' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( get_permalink() ) ); ?>
							</p>
