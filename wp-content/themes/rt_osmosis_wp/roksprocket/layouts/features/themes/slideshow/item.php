<?php
/**
 * @version   $Id: item.php 20444 2014-04-15 10:14:25Z arifin $
...
<li class="sprocket-features-index-<?php echo $index;?>">
	...
	<div class="sprocket-features-img-container" data-slideshow-image>
		<?php if ($item->getPrimaryLink()) : ?>
			<a href="<?php echo $item->getPrimaryLink()->getUrl(); ?>"><img src="<?php echo $image->getSource(); ?>" alt="" style="max-width: 100%; height: auto;" /><span class="sprocket-image-overlay"></span></a>
		<?php else: ?>
