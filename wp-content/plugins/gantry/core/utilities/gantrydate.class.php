...
class GantryDate
{
	...
	protected function monthToString($month, $abbr = false)
	{
		switch ($month) {
			case 1:
				return $abbr ? _g('JANUARY_SHORT') : _g('JANUARY');
			case 2:
				return $abbr ? _g('FEBRUARY_SHORT') : _g('FEBRUARY');
			case 3:
				return $abbr ? _g('MARCH_SHORT') : _g('MARCH');
			case 4:
				return $abbr ? _g('APRIL_SHORT') : _g('APRIL');
			case 5:
				return $abbr ? _g('MAY_SHORT') : _g('MAY');
			case 6:
				return $abbr ? _g('JUNE_SHORT') : _g('JUNE');
			case 7:
				return $abbr ? _g('JULY_SHORT') : _g('JULY');
			case 8:
				return $abbr ? _g('AUGUST_SHORT') : _g('AUGUST');
			case 9:
				return $abbr ? _g('SEPTEMBER_SHORT') : _g('SEPTEMBER');
			case 10:
				return $abbr ? _g('OCTOBER_SHORT') : _g('OCTOBER');
			case 11:
				return $abbr ? _g('NOVEMBER_SHORT') : _g('NOVEMBER');
			case 12:
				return $abbr ? _g('DECEMBER_SHORT') : _g('DECEMBER');
		}
	}
	...
	protected function dayToString($day, $abbr = false)
	{
		switch ($day) {
			case 0:
				return $abbr ? _g('SUN') : _g('SUNDAY');
			case 1:
				return $abbr ? _g('MON') : _g('MONDAY');
			case 2:
				return $abbr ? _g('TUE') : _g('TUESDAY');
			case 3:
				return $abbr ? _g('WED') : _g('WEDNESDAY');
			case 4:
				return $abbr ? _g('THU') : _g('THURSDAY');
			case 5:
				return $abbr ? _g('FRI') : _g('FRIDAY');
			case 6:
				return $abbr ? _g('SAT') : _g('SATURDAY');
		}
	}
