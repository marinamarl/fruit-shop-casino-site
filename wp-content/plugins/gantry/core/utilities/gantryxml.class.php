 ...
 *
 * The XML Parser extension (expat) is required to use GantryXML.
 *
 ...
 * GantryXML, not implicit as with PHP5. Write
 ...
 * </code>
 *
 * Note: GantryXML cannot be used to access sophisticated XML doctypes
...
class GantryXML
{
	 ...
	 * GantryXMLElement with properties containing the data held within the xml document.
	 ...
	 * to an object  of class GantryXMLElement. If any errors occur during file access or
	...
	/**
	 * Get a GantryXMLElement object from a DOM node.
	 *
	 * This function takes a node of a DOM  document and makes it into a GantryXML node.
...
class GantryXMLElement
{
	...
	/**
	 * traverses the tree calling the $callback( GantryXMLElement
