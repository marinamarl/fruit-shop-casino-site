...
class GantryPlatform
{
	...
	protected function getPlatformInfo()
	{
		...
		if (defined('_JEXEC') && defined('JVERSION')) {
			...
			$this->versionFilter = 'joomlaVersionFilter';
			...
			$this->versionFilter = 'wordpressVersionFilter';
		} else {
			$this->unsuportedInfo();
		}
	}
	...
	public function getAvailablePlatformVersions($dir)
	{
		...
		$entries = array_filter($entries, array('GantryPlatform',$this->versionFilter));
	...
	public static function wordpressVersionFilter($version){
		global $wp_version;
