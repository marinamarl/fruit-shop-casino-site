...
<form autocomplete="off" action="<?php echo (isset($this->base_url)) ? $this->base_url : ''; ?>"
	...
	<div id="tabs-container">
		<div class="roksprocket-version">RokSprocket <span>v<?php echo str_replace("\2.1.20", "DEV", ROKSPROCKET_VERSION); ?></span></div>
		<?php if ($that->data->id > 0): ?>
		<ul class="tabs">
			<li class="badge">
				<?php
