<?php
/**
 * @version $Id: tinymce.php 28989 2015-10-14 07:58:27Z jakub $
...
class RokSprocket_TinyMCE
{
     ...
     */
    public static function roksprocket_tinymce_ajax()
    {
     ...
     */
    public static function roksprocket_quicktags() {
        global $wp_version;
...
add_action('admin_print_footer_scripts', array('RokSprocket_TinyMCE', 'roksprocket_quicktags'), 100);
