				...
				<tbody>
					<tr>
						...
						<td class="rightcol">
							...
							<div class="branding">
								<h1>RokBox 2.50.10</h1>
							</div>
							<div class="desc">
								<p class="description">
									<strong>RokBox </strong> <?php _e( 'is a fully responsive modal plug-in for WordPress. Rewritten from the ground up it can display many different media formats such as images, videos, music, embedded widgets, Ajax content and WordPress widgets and takes advantage of the new technologies such as HTML5 and CSS3.', 'rokbox' ); ?>
								</p>
							</div>
						</td>
					</tr>
